...
Scoring: substantive development 45, recognized significance 20, source authority at most 5, recency at most 5, additional source ownership at most 5. There is no primary-source bonus, automatic novelty bonus, Pakistan-keyword bonus or article quota. More ownership is not asserted to be independent factual corroboration. Threshold remains 65; failure of the substantive-development gate cannot be rescued by the other factors.
...
Each new endpoint needs a restrictions/robots review and successful parsing/current-date tests before enabling it. Reporting feeds remain headlines/links only; no newspaper full-text rewriting, paywall bypass or paid service is needed by this policy. No unverified endpoints were enabled or added in this assignment. Source-health failures and category defaults still require editor oversight.
