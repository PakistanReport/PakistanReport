...
export const sources = [
  ...
  },
  {
    ...
    role: "reporting",
    owner: "Fixture wire",
    ownership: {status:"reviewed",group:"Fixture wire",reference:"https://wire.example/ownership"},
    discoveryPermission: {status: "approved", basis: "Synthetic fixture transport only; no real publisher content or permission implied.", reference: "https://wire.example/fixture-permission", endpoint: "https://wire.example/feed", hosts: ["wire.example"], reviewedAt: "2026-09-12T00:00:00Z"},
    authority: 0.9,
    priority: 70,
    intervalMinutes: 60,
    enabled: true,
  ...
  },
  {
    ...
    ownership: {status:"reviewed",group:"Fixture second outlet",reference:"https://report.example/ownership"},
    authority: 0.9,
    priority: 70,
    intervalMinutes: 60,
    enabled: false,
